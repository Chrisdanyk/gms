...
describe('Notification e2e test', () => {
  ...
  const notificationSample = { date: '2021-12-29', statut: 'EN_COURS', nuid: 'Kwacha Shoes Metal' };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2021-12-28').should('have.value', '2021-12-28');

      cy.get(`[data-cy="statut"]`).select('ENVOYE');

      cy.get(`[data-cy="dateProchaineMaintenance"]`).type('2021-12-29').should('have.value', '2021-12-29');

      cy.get(`[data-cy="nuid"]`).type('Chips superstructure').should('have.value', 'Chips superstructure');
